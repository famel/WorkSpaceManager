...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "WorkSpaceManager Identity Service",
        Version = "v1",
        Description = "Authentication, authorization, and user management service for WorkSpaceManager"
    });
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "WorkSpaceManager Identity Service v1");
    });
}
